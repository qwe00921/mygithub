...
//	};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mClearHistoryWordsTextView = (TextView) findViewById(R.id.clear_history_words_tv);
...
//		mListViewSearch.addHeaderView(view);
		...
		mClearHistoryWordsTextView.setOnClickListener(this);
//		
...
//		mListViewSearch.setVisibility(View.VISIBLE);
		...
		if(mHistoryWordsModels == null || mHistoryWordsModels.size() == 0) {
			suggestPanel.setVisibility(View.INVISIBLE);
			return;
		}
		suggestPanel.setVisibility(View.VISIBLE);
		mClearHistoryWordsTextView.setVisibility(View.VISIBLE);
...
//				|| null == mAutoCompleteHotkeyAdapter
//				)
//			return;
//		
//		mListViewSearch.setVisibility(View.VISIBLE);
...
//			ToolUtil.reportStatisticsClick(getActivityPageId(), "21002");
			break;
//			
		case R.id.clear_history_words_tv:
...
//		
		...
		Bundle param = new Bundle();
		param.putSerializable(ListActivity.KEY_SEARCH_KWD, keyWord);
		param.putBoolean(ListActivity.KEY_FROM_SEARCH, true);
		ToolUtil.startActivity(this, ListActivity.class, param);
		//}
	}
