...
public final class GetFavArticleListRsp extends com.duowan.taf.jce.JceStruct implements java.lang.Cloneable
{
    ...
    public void readFrom(com.duowan.taf.jce.JceInputStream _is)
    {
        if(null == cache_articleList)
        {
            ...
            com.duowan.gamenews.ArticleInfo __var_46 = new com.duowan.gamenews.ArticleInfo();
            ((java.util.ArrayList<com.duowan.gamenews.ArticleInfo>)cache_articleList).add(__var_46);
        }
