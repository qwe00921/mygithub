...
public final class GetMyFavChannelListReq extends com.duowan.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "gamenews.GetMyFavChannelListReq";
    }

    public String fullClassName()
    {
        return "com.duowan.gamenews.GetMyFavChannelListReq";
    }
    ...
    public GetMyFavChannelListReq()
    {
        setCount(count);
        setAttachInfo(attachInfo);
    }

    public GetMyFavChannelListReq(int count, String attachInfo)
    {
        setCount(count);
        setAttachInfo(attachInfo);
    }
    ...
    public boolean equals(Object o)
    {
        ...
        GetMyFavChannelListReq t = (GetMyFavChannelListReq) o;
        return (
