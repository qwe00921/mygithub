...
public final class GetVideoUrlReq extends com.duowan.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "gamenews.GetVideoUrlReq";
    }

    public String fullClassName()
    {
        return "com.duowan.gamenews.GetVideoUrlReq";
    }
    ...
    public GetVideoUrlReq()
    {
        setArticleId(articleId);
    }

    public GetVideoUrlReq(long articleId)
    {
        setArticleId(articleId);
    }
    ...
    public boolean equals(Object o)
    {
        ...
        GetVideoUrlReq t = (GetVideoUrlReq) o;
        return (
