...
public final class GetMyFavChannelListRsp extends com.duowan.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "gamenews.GetMyFavChannelListRsp";
    }

    public String fullClassName()
    {
        return "com.duowan.gamenews.GetMyFavChannelListRsp";
    }
    ...
    public GetMyFavChannelListRsp(java.util.ArrayList<com.duowan.gamenews.Channel> channelList, int hasMore, String attachInfo)
    {
        setChannelList(channelList);
        setHasMore(hasMore);
        setAttachInfo(attachInfo);
    ...
    public boolean equals(Object o)
    {
        ...
        GetMyFavChannelListRsp t = (GetMyFavChannelListRsp) o;
        return (
    ...
    public void readFrom(com.duowan.taf.jce.JceInputStream _is)
    {
        if(null == cache_channelList)
        {
            ...
            com.duowan.gamenews.Channel __var_29 = new com.duowan.gamenews.Channel();
            ((java.util.ArrayList<com.duowan.gamenews.Channel>)cache_channelList).add(__var_29);
        }
