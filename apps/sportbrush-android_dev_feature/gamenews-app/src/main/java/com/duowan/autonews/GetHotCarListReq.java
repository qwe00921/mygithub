...
public final class GetHotCarListReq extends com.duowan.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "autonews.GetHotCarListReq";
    }

    public String fullClassName()
    {
        return "com.duowan.autonews.GetHotCarListReq";
    }
    ...
    public GetHotCarListReq()
    {
        setCount(count);
        setAttachInfo(attachInfo);
    }

    public GetHotCarListReq(int count, String attachInfo)
    {
        setCount(count);
        setAttachInfo(attachInfo);
    }
    ...
    public boolean equals(Object o)
    {
        ...
        GetHotCarListReq t = (GetHotCarListReq) o;
        return (
