...
public final class GetCarBrandListReq extends com.duowan.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "autonews.GetCarBrandListReq";
    }

    public String fullClassName()
    {
        return "com.duowan.autonews.GetCarBrandListReq";
    }
    ...
    public GetCarBrandListReq()
    {
        setCount(count);
        setAttachInfo(attachInfo);
    }

    public GetCarBrandListReq(int count, String attachInfo)
    {
        setCount(count);
        setAttachInfo(attachInfo);
    }
    ...
    public boolean equals(Object o)
    {
        ...
        GetCarBrandListReq t = (GetCarBrandListReq) o;
        return (
