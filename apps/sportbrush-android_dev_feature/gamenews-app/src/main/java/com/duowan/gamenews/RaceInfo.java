...
public final class RaceInfo extends com.duowan.taf.jce.JceStruct implements java.lang.Cloneable
{
    ...
    public void readFrom(com.duowan.taf.jce.JceInputStream _is)
    {
        ...
        if(null == cache_teamList)
        {
            ...
            com.duowan.gamenews.Team __var_57 = new com.duowan.gamenews.Team();
            ((java.util.ArrayList<com.duowan.gamenews.Team>)cache_teamList).add(__var_57);
        }
        ...
        if(null == cache_liveSourceList)
        {
            ...
            String __var_58 = "";
            ((java.util.ArrayList<String>)cache_liveSourceList).add(__var_58);
        }
