...
public final class ReportArticleReq extends com.duowan.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "gamenews.ReportArticleReq";
    }

    public String fullClassName()
    {
        return "com.duowan.gamenews.ReportArticleReq";
    }
    ...
    public ReportArticleReq()
    {
        setArticleId(articleId);
    }

    public ReportArticleReq(long articleId)
    {
        setArticleId(articleId);
    }
    ...
    public boolean equals(Object o)
    {
        ...
        ReportArticleReq t = (ReportArticleReq) o;
        return (
