...
public final class AddtopicRsp extends com.duowan.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "show.AddtopicRsp";
    }

    public String fullClassName()
    {
        return "com.duowan.show.AddtopicRsp";
    }
    ...
    public AddtopicRsp(int topicId)
    {
        setTopicId(topicId);
    }
