...
public final class AppOption
{
    ...
    public static final int _FLAG_APP_OPTION_NOT_DISPLAY_SHOW = 1;
    public static final AppOption FLAG_APP_OPTION_NOT_DISPLAY_SHOW = new AppOption(0,_FLAG_APP_OPTION_NOT_DISPLAY_SHOW,"FLAG_APP_OPTION_NOT_DISPLAY_SHOW");
