...
public final class CheckInActionRsp extends com.duowan.taf.jce.JceStruct implements java.lang.Cloneable
{
    ...
    public CheckInActionRsp(String desc, int checkInType, String giftCode, java.util.ArrayList<com.duowan.gamenews.Button> button)
    {
        setDesc(desc);
        setCheckInType(checkInType);
        setGiftCode(giftCode);
    ...
    public void readFrom(com.duowan.taf.jce.JceInputStream _is)
    {
        ...
        if(null == cache_button)
        {
            ...
            com.duowan.gamenews.Button __var_79 = new com.duowan.gamenews.Button();
            ((java.util.ArrayList<com.duowan.gamenews.Button>)cache_button).add(__var_79);
        }
