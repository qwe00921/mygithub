package com.yy.android.gamenews.util.db;
...
public abstract class Database {
	...
	public void close() {
		...
		try {
			...
			errCode = 1001;
			errMsg = LOG_TAG + "|close|" + Util.getStackTraceString(ex);
	...
	public Cursor getCursor(String sql, String[] params) {
		...
		try {
			...
			errCode = 1002;
			errMsg = LOG_TAG + "|query|" + Util.getStackTraceString(ex);
			cursor = null;
			Log.e(LOG_TAG, errMsg);
		}
	...
	public String getValue(String sql, String[] params) {
		...
		try {
			...
			errCode = 1004;
			errMsg = LOG_TAG + "|getValue|" + Util.getStackTraceString(ex);
			Log.e(LOG_TAG, errMsg);
			if (null != cursor)
				cursor.close();
		}
	...
	public boolean execute(String sql, Object[] params) {
		...
		try {
			...
			errCode = 1006;
			errMsg = LOG_TAG + "|execute|" + Util.getStackTraceString(ex);
			Log.e(LOG_TAG, errMsg);
		}
