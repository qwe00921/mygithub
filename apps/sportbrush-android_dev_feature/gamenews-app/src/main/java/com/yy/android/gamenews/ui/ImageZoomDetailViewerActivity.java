...
import com.yy.android.gamenews.ui.view.CustomPagerAdapter;
...
public class ImageZoomDetailViewerActivity extends BaseActivity {
	...
	public static void startZoomDetailActivity(Context context,
		...
		intent.putExtra(ImageZoomDetailViewerActivity.EXTRA_IMAGE_LIST_ZOOM,
				picList);
		intent.putExtra(ImageZoomDetailViewerActivity.EXTRA_TITLE, title);
	...
	private Handler mHandler = new UIHandler(ImageZoomDetailViewerActivity.this);
