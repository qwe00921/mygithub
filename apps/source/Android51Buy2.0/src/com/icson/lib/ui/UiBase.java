...
public class UiBase extends LinearLayout {
	...
	private void parseAttrs(AttributeSet attrs) {
		...
		TypedArray array = pContext.obtainStyledAttributes(attrs, R.styleable.icsonattrs);
		mReferWidth = UiUtils.getInteger(pContext, array, R.styleable.icsonattrs_referWidth, 0);
		mReferHeight = UiUtils.getInteger(pContext, array, R.styleable.icsonattrs_referHeight, 0);
