 ...
 * 				content         TEXT comment '存储的内容，主要的数据 部分', 
 * 				row_create_time INTEGER comment '记录的创建时间', 
 * 				row_expire_time INTEGER  comment '过期的时间'
 * 			   )
