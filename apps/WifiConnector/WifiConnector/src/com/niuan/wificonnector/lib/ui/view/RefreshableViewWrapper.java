package com.niuan.wificonnector.lib.ui.view;
...
import com.niuan.wificonnector.lib.ui.util.Counter;
import com.niuan.wificonnector.lib.ui.util.Counter.OnCounterCallback;
import com.niuan.wificonnector.lib.ui.util.CounterItem;
import com.niuan.wificonnector.lib.ui.util.TimeUtil;
...
public abstract class RefreshableViewWrapper<E extends View> {
	...
	private void updateRefreshTime() {
		mHeaderLastUpdatedTv.setText(String.format("上次更新：%s",
	...
	public void showErrorLoadingBar() {
		...
		mFooterTipsTv.setText("加载失败，点击重试");
